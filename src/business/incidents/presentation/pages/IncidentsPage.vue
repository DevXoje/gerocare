...
import { useIncidentForm } from '../../app/useIncidentForm'
import { useIncidents } from '../../app/useIncidents'
...
const { incidents, isLoading, error, loadIncidents } = useIncidents()
...
onMounted(async () => {
  await loadIncidents(residentId.value)
})
