...
export interface ResidentRepository {
   ...
   */
  create(resident: Omit<Resident, 'id' | 'createdAt' | 'updatedAt'>): Promise<Result<Resident, ResidentError>>
   ...
   */
  update(id: string, updates: Partial<Omit<Resident, 'id' | 'createdAt'>>): Promise<Result<Resident, ResidentError>>
