...
vi.mock('firebase/auth', async () => {
  ...
  return {
    ...actual,
    signInWithPopup: (_auth: Auth, _provider: AuthProvider) => mockSignInWithPopupFn(_auth, _provider),
...
describe('FirestoreAuth - signInWithGoogle', () => {
  ...
  describe('error handling', () => {
    it('should handle popup closed by user error', async () => {
      const firebaseError = new FirebaseError('auth/popup-closed-by-user', 'Popup was closed by user')
    ...
    it('should handle cancelled popup request error', async () => {
      const firebaseError = new FirebaseError('auth/cancelled-popup-request', 'Popup request was cancelled')
      mockSignInWithPopupFn.mockRejectedValue(firebaseError)
...
describe('FirestoreAuth - signUp', () => {
  ...
  describe('successful sign up', () => {
    it('should sign up successfully with email and password', async () => {
      ...
      expect(result.success).toBe(true)
      expect(mockCreateUserWithEmailAndPasswordFn).toHaveBeenCalledWith(expect.anything(), 'newuser@example.com', 'password123')
  ...
  describe('error handling', () => {
    ...
    it('should handle weak password error', async () => {
      const firebaseError = new FirebaseError('auth/weak-password', 'Password should be at least 6 characters')
      mockCreateUserWithEmailAndPasswordFn.mockRejectedValue(firebaseError)
