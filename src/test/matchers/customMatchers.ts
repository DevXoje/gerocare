  ...
  toBeValidResident(received: Resident) {
    ...
    if (pass) {
      ...
      if (typeof received !== 'object' || received === null) {
        ...
        if (!Array.isArray(received.emergencyContacts)) missingFields.push('emergencyContacts (array)')
        if (!Array.isArray(received.assignedCaregivers)) missingFields.push('assignedCaregivers (array)')
