...
export const isThemeMode = (value: string | null | undefined): value is ThemeMode => (!!value) && themeModeValues.includes(value as ThemeMode)
...
export const themeModeValues: ThemeMode[] = [
  ThemeMode.Light,
  ThemeMode.Dark,
  ThemeMode.Auto,
]

export const getThemeOption = (themeMode: ThemeMode): SelectOption<ThemeMode> => themeModeOptions.find((option) => option.value === themeMode) ?? themeModeOptions[0]!
