/**
 * Firebase Auth Patterns - Example Code
 *
 * These are reference examples showing Firebase Auth patterns used in GeroCare.
...
/**
 * Map Firebase Auth errors to domain AuthError types
 */
...
/**
 * Convert Firebase UserCredential to domain User
 */
